...
|-------|---------|-------|------------|
| 0 | Component API contract | `fn-component-api` | Enums not booleans, defaults, naming |
| 1 | React patterns | `fn-react-patterns` | forwardRef, rest spread, RSC, hooks |
| 2 | Semantic HTML + ARIA | `fn-html` | Native elements, ARIA roles, keyboard |
| 3 | WCAG 2.2 AA accessibility | `fn-accessibility` | Scored audit (B1-B6), rules A01-A30 |
| 4 | Token integrity | `fn-tokens` | Cascade chain, no hardcoded values |
| 5 | CSS/SCSS authoring | `fn-css` | Seven non-negotiables, section order |
...
- `fn-testing` -- Run after review to verify test coverage matches findings
- `fn-component-scaffold` -- If component needs full rewrite, scaffold from scratch
- `fn-storybook-docs` -- Generate docs stories after review passes
