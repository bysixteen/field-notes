...
|---------------|---------------------|
| `fn-tokens` | CSS reads token values -- audit token cascade integrity alongside CSS |
| `fn-accessibility` | Focus ring rules and :not() guards directly affect a11y compliance |
| `fn-component-scaffold` | Scaffold generates CSS file following these rules |
| `fn-review` | Full review runs CSS audit as Stage 5 |
| `fn-html` | HTML semantics determine which selectors are appropriate |
