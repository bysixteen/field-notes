...
Spatial breathing room in response to the layout environment.

| Value | Use |
|-------|-----|
| `default` | Standard product UI — dashboards, forms, data tables |
| `relaxed` | Spacious contexts — onboarding, marketing, empty states |
