...
|---------------|---------------------|
| `fn-component-api` | API defines props interface that React implementation must honor |
| `fn-component-scaffold` | Scaffold generates TSX following these patterns |
| `fn-html` | HTML element choice determines forwardRef generic type |
| `fn-review` | Full review runs React patterns as Stage 1 |
| `fn-testing` | Test patterns depend on React implementation (render, fireEvent) |
| `fn-css` | CSS handles visual states; React should not duplicate with useState |
