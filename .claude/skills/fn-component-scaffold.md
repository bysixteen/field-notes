...
6. Run `fn-review` for full audit
...
NEXT STEPS:
  ...
  3. Run `fn-review` for full audit
===========================================================
```
...
|---------------|---------------------|
| `fn-component-api` | Run FIRST to decide dimensions, props, and slots before scaffolding |
| `fn-tokens` | After scaffold, define token collections for each dimension |
| `fn-css` | CSS file must follow seven-section order and all non-negotiables |
| `fn-react-patterns` | TSX file must follow forwardRef, rest spread, composition patterns |
| `fn-testing` | Test file structure follows three-layer strategy |
| `fn-storybook-docs` | After scaffold, generate comprehensive documentation stories |
| `fn-accessibility` | Run after scaffold to verify a11y compliance |
