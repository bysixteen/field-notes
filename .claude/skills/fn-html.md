...
|---------------|---------------------|
| `fn-accessibility` | HTML decisions directly feed a11y audit rules (A01-A05, A19) |
| `fn-component-api` | API decisions (link vs button) determine HTML element choice |
| `fn-react-patterns` | React implementation of HTML patterns (forwardRef on correct element) |
| `fn-review` | Full review runs HTML semantics as Stage 2 |
| `fn-css` | HTML elements determine valid CSS selectors |
